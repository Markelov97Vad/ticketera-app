  ...
  return (
    <section className={styles['main-frame']}>
      <div className={styles['main-frame__img-wrapper']}>
        <img className={styles["main-frame__img"]} src={eventData?.image} alt={eventData?.name} />
      </div>
      <div className={styles["main-frame__container"]}>
        <div className={styles["main-frame__buttons"]}>
          ...
          <div className={styles["main-frame__button-like"]}>
            ...
            <span className={styles['main-frame__button-title']}>Избранное</span>
          </div>
        </div>
        <div className={styles["main-frame__info"]}>
          ...
          <div className={`${styles["main-frame__date"]} ${styles["main-frame__event-info"]}`}>
            <TimeIcon color='white'/>
            <span className={styles["main-frame__date-title"]}>{supportFunction.renderDate(eventData?.date_event)}, {supportFunction.renderTime(eventData?.time_event)}</span>
          </div>
          <div className={`${styles["main-frame__location"]} ${styles["main-frame__event-info"]}`}>
            <PlaceIcon color='white'/>
            <span className={styles["main-frame__location-title"]}>{eventData?.place?.city?.name}, {eventData?.place?.name}</span>
          </div>
        </div>
      </div>
    </section >
