					...
					>
						<span
							className={`${styles.date__day} ${
								day === selectedDay ? styles['date__selected'] : ''
							}`}
						>
							{day}
						</span>
						<span
							className={`${styles.date__weekday} ${
								weekDays[(day + firstDayOfWeekIndex - 1) % 7] === 'сб' ||
								weekDays[(day + firstDayOfWeekIndex - 1) % 7] === 'вс'
									? styles.date__weekend
									: ''
							}`}
						>
